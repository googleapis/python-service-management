Python Client for Service Management API API
============================================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-service-management.svg
   :target: https://pypi.org/project/google-cloud-service-management/
.. _Service Management API API: https://cloud.google.com/service-infrastructure/docs/overview/
...
3. `Enable the Service Management API API.`_
4. `Setup Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Service Management API API.:  https://cloud.google.com/service-infrastructure/docs/overview/
...
-  Read the `Client Library Documentation`_ for Service Management API API
   to see other available methods on the client.
-  Read the `Service Management API API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Service Management API API Product documentation:  https://cloud.google.com/service-infrastructure/docs/overview/
